...
@WebFluxTest(RestControllerPaymentToUpV1.class)
public class RestControllerPaymentToUpV1Test {
    ...
    public void testTransactionEntityFlux() {
        ...
        webTestClient.get()
                .uri("/api/v1/payments/toup/transaction/list")
                .exchange()
                .expectStatus().isOk()
    ...
    public void testCreateTransaction() {
        ...
        webTestClient.post()
                .uri("/api/v1/payments/toup/transaction/create")
